document.addEventListener("DOMContentLoaded", function() {
    const artistsData = {
        fruits: {
            songs: [
                { name: "完璧主義で☆", url: "https://www.youtube.com/embed/pFVaqv7pb1k?si=lbOYGn7LacsEChoV&amp;start=220" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>", desc:"元気になれる明るい曲" },
                { name: "フルーツバスケット", url: "https://youtu.be/bRRPqGRguKo?si=CgQmIYG-b60fwIye", desc:"かわいいメロディが特徴" },
                { name: "君と目があったとき", url: "https://www.youtube.com/embed/T55SROZ5S78", desc:"zoffとタイアップ" }
            ]
        },
        fujii: {
            songs: [
